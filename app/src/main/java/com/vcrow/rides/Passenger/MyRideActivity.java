package com.vcrow.rides.Passenger;
...
import static com.vcrow.rides.Utils.Constants.completedRideKey;

public class MyRideActivity extends AppCompatActivity {

    private String id = "";
    private TextView status, d_name, car_details, pick_loc,
            drop_loc, distance, price, estimated_tim;
